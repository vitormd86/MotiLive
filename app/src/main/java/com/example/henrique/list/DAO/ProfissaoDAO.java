...
public class ProfissaoDAO extends AsyncTask<Void, Void, Boolean> {
    ...
    public ProfissaoDAO(Context context) throws SQLException {

        this.context = context;

    }

    public void adiciona(Profissao profissao) throws SQLException, java.sql.SQLException {
// prepared statement para inserção
        int id = profissao.getId();
        String nome = profissao.getNome();
        try {

            PreparedStatement stmt;
            stmt = con.prepareStatement("INSERT INTO PROFISSAO(ID,NOME) VALUES(?,?)");
    ...
    public void remove(Profissao profissao) throws SQLException, java.sql.SQLException {
// prepared statement para inserção
        int id = profissao.getId();
        String nome = profissao.getNome();
        try {
            ...
            PreparedStatement stmt;
            stmt = con.prepareStatement("DELETE FROM PROFISSAO WHERE ID="+id+" AND ID_PESSOA="+nome );
    ...
    public void update(Profissao profissao) throws SQLException, java.sql.SQLException {
// prepared statement para inserção
        int id = profissao.getId();
        String nome = profissao.getNome();
        try {
            ...
            PreparedStatement stmt;
            stmt = con.prepareStatement("UPDATE CLIENTE SET NOME="+nome+" WHERE id="+id );
