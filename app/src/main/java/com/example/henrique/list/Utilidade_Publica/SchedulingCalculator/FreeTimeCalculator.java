...
public class FreeTimeCalculator {
    public static ArrayList<Integer> findFreeHoursByServicesTime(List<PeriodDTO> periodDTOList, DailyScheduleDTO dailyScheduleDTO, List<ServiceDTO> selectedServices){
    ...
    public static ArrayList<Integer> findFreeMinutesByServicesTime(int selectedHour, List<PeriodDTO> periodDTOList, List<ServiceDTO> selectedServices){
    ...
    public static ArrayList<Integer> findFreeHoursByCalendar(List<PeriodDTO> periodDTOList, DailyScheduleDTO dailyScheduleDTO, Calendar delayCal){
        ArrayList<Integer> freeHours = new ArrayList<>();
        delayCal.setTimeZone(TimeZone.getDefault());
        System.out.println("Tamanho da periodDTOlist: " + periodDTOList.size());
        ...
        for (PeriodDTO periodDTO : periodDTOList){
            ...
            System.out.println("Novo periodo");
            Calendar initialPeriodCal = periodDTO.getStartTime();
            Calendar finalPeriodCal = subtractCalendarTime(periodDTO.getEndTime(), delayCal);
            initialPeriodCal.setTimeZone(TimeZone.getDefault());
            finalPeriodCal.setTimeZone(TimeZone.getDefault());
            System.out.println("Periodo de " + initialPeriodCal.get(Calendar.HOUR_OF_DAY) + ":"
                    + initialPeriodCal.get(Calendar.MINUTE) + " ate "
    ...
    public static ArrayList<Integer> findFreeMinutesByCalendar(int selectedHour, List<PeriodDTO> periodDTOList, Calendar delayCal){
        ArrayList<Integer> freeMinutes = new ArrayList<>();
        delayCal.setTimeZone(TimeZone.getDefault());
        System.out.println("Tamanho da periodDTOlist: " + periodDTOList.size());
        for (PeriodDTO periodDTO : periodDTOList){
    ...
    public static boolean isFreeHourDay(List<PeriodDTO> periodDTOList, DailyScheduleDTO dailyScheduleDTO, List<ServiceDTO> selectedServices){
        ...
        ArrayList<Integer> freeHours = new ArrayList<>();
        freeHours.addAll(findFreeHoursByServicesTime(periodDTOList, dailyScheduleDTO, fasterServiceList));
        if(freeHours.size() <= 0){
    ...
    private static Calendar subtractCalendarTime(Calendar finalPeriodCal, Calendar toSubractCal){
        //este metodo remove os minutos e as horas do calendario do final do periodo
        Calendar subtractedCal = Calendar.getInstance();
        Calendar toSubtractCal = Calendar.getInstance();

        subtractedCal.setTime(finalPeriodCal.getTime());
        toSubtractCal.setTime(toSubractCal.getTime());
        subtractedCal.setTimeZone(TimeZone.getDefault());
        toSubtractCal.setTimeZone(TimeZone.getDefault());
